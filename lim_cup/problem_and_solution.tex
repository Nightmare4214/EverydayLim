...
\begin{align*}
    ...
    \end{pmatrix}A (\xi_1,\xi_2,\xi_3)\begin{pmatrix}
        ...
        0
    \end{pmatrix}\\
    &=(-\xi_1+2\xi_2)^T(5\xi_1,5\xi_2,\lambda \xi_3)\begin{pmatrix}
        -1\\
        2\\
        0
    \end{pmatrix}\\
...
\begin{align*}
    ...
    &=\int_{1}^{2}x^2\left. (-\frac{y^2 e^{-xy}}{x}-\frac{2y e^{-xy}}{x^2}-\frac{2e^{-xy}}{x^3})\right|_{0}^{+\infty}\mathrm{d}x\\
    &=\int_{1}^{2}\frac{2}{x}\mathrm{d}x\\
